...
function ChannelLink({ img, link, name, yt }) {
  return (
    <a
      href={link}
      target="_blank"
    ...
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert">
        <p>I am on an engineering pursuit of excellence. I try to spend time everyday working toward this goal. To be a better thinker, 
          solve harder problems, build better products, FASTER. To build a great product efficiently, you really have to hone your 
          enginnering skills and critical problem solving. Think of the big picture, your customer needs, weigh the benefits of every action
          you take against meeting goals.
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert">
        <p>
          I'm on a mission. That's all I have to say about that.
        </p>
      </div>
